...
- `skills/` — the operational skills (`define-preamble`, `harvest-articles`, `harvest-statutes`, `derive-statutes`, `audit-structure`, `audit-conformance`, `reconcile-findings`, `compile-prompt`, `sync-operator`) — how day-to-day work actually happens
